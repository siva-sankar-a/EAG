...
async def draw_rectangle(x1: int, y1: int, x2: int, y2: int) -> dict:
    ...
    try:
        ...
        paint_window.click_input(coords=(540, 100))
        time.sleep(0.2)
        ...
        canvas.press_mouse_input(coords=(x1+1970, y1+180))
        canvas.move_mouse_input(coords=(x2+1970, y2+180))
        canvas.release_mouse_input(coords=(x2+1970, y2+180))
...
async def add_text_in_paint(text: str) -> dict:
    """Add text in Paint at the coordinate (500, 550)"""
    global paint_app
    try:
        if not paint_app:
            return {
        ...
        canvas.click_input(coords=(540, 700))
        time.sleep(0.5)
